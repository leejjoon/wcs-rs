...
def test_another_projection_unprojection():
    ...
    test_lon, test_lat = 1.0, -1.0 # 1 degree offset in lon, -1 degree in lat
...
def test_wcs_creation_failure_missing_naxis_keywords():
    ...
    with pytest.raises(ValueError, match="MandatoryWCSKeywordsMissing"): # Matching part of "Mandatory WCS keyword NAXIS1 is missing"
...
def test_projection_to_none_if_outside_projection_domain():
    ...
    params_dict_simple = {
        "NAXIS": 2, "CTYPE1": "RA---SIN", "CTYPE2": "DEC--SIN", # SIN projection
        "CRVAL1": 0.0, "CRVAL2": 0.0, "CRPIX1": 50.0, "CRPIX2": 50.0,
        "CUNIT1": "deg", "CUNIT2": "deg", "CD1_1": -0.1, "CD2_2": 0.1,
